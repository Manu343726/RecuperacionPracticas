...
/// @author	Manu343726
///////////////////////////////////////////////////////////////////////////////////////////////////////
enum /* C++11 class */ dl32StyleChange
{
    FOREGROUND,
    BACKGROUND
};
...
public:  
    ...
    void execute_change( dl32ConsoleColor color )
    {
        switch( _last_change )
        {
            case BACKGROUND: change_background( color ); break;
            case FOREGROUND: change_foreground( color ); break;
        }
    }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
template<bool VALUE>
struct dl32SetAutoPush /* cpp_lib32 type utilities is full of C++11. : public dl32ValueWrapper<bool,VALUE> */
{
private:
    typedef dl32SetAutoPush<VALUE> auto_push_type;
public:
